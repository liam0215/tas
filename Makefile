...
CFLAGS += -std=gnu99 -O3 -g -Wall -Werror -march=native -fno-omit-frame-pointer -Wno-address-of-packed-member -Wno-maybe-uninitialized -Wno-deprecated-declarations
CFLAGS += $(EXTRA_CFLAGS)
