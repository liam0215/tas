...
from exps.overhead_throughput_shortflows.configs.container_ovs_dpdk import Config as ContainerOvsDpdkConf
...
for n_r in range(n_runs):
  for flow_len in flow_lens:
    ...
    container_ovs_dpdk_exp = exp.Experiment(ContainerOvsDpdkConf(exp_name + "container-ovsdpdk", flow_len), name=exp_name)
